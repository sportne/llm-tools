...
These YAML files configure `llm_tools.apps.assistant_app` for common
assistant usage modes.

The YAML file is optional. The LLM Tools Assistant can start without one, and
...
enabled per session in the assistant settings.
...
- `assistant_configs/local-only-chat.yaml`
  ...
  Launch: `llm-tools-assistant . --config examples/assistant_configs/local-only-chat.yaml`
- `assistant_configs/enterprise-data-chat.yaml`
  ...
  Launch: `llm-tools-assistant --config examples/assistant_configs/enterprise-data-chat.yaml`
- `assistant_configs/harness-research-chat.yaml`
  ...
  Launch: `llm-tools-assistant . --config examples/assistant_configs/harness-research-chat.yaml`
