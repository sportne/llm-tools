...
These YAML files configure `llm_tools.apps.nicegui_chat` for common
assistant usage modes.

The YAML file is optional. The NiceGUI assistant can start without one, and
...
enabled per session in the NiceGUI settings.
...
- `assistant_configs/local-only-chat.yaml`
  ...
  Launch: `llm-tools-nicegui-chat . --config examples/assistant_configs/local-only-chat.yaml`
- `assistant_configs/enterprise-data-chat.yaml`
  ...
  Launch: `llm-tools-nicegui-chat --config examples/assistant_configs/enterprise-data-chat.yaml`
- `assistant_configs/harness-research-chat.yaml`
  ...
  Launch: `llm-tools-nicegui-chat . --config examples/assistant_configs/harness-research-chat.yaml`
